  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        cta: {
          secondary: "var(--color-cta-secondary)", /* amber-500 */
          'secondary-foreground': "var(--color-cta-secondary-foreground)", /* white */
        },
      },
      borderRadius: {
        lg: "var(--radius-lg)",
      ...
      boxShadow: {
        'elevation-sm': '0 2px 4px -1px rgba(0, 0, 0, 0.06), 0 1px 2px -1px rgba(0, 0, 0, 0.04)',
