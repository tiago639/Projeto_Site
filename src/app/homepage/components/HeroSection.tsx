        ...
        <div className="grid lg:grid-cols-2 gap-8 xl:gap-12 items-center">
          <div className="space-y-8 text-center lg:text-left">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
              ...
              >
                Ver Projetos
                <svg className="ml-2 w-5 h-5 group-hover:translate-x-1 transition-transform duration-base" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              >
                Entre em Contato
                <svg className="ml-2 w-5 h-5 group-hover:scale-110 transition-transform duration-base" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="relative lg:block hidden">
            <div className="relative w-full max-w-xs lg:max-w-sm xl:max-w-md 2xl:max-w-lg mx-auto">
              <div className="absolute inset-0 bg-gradient-to-r from-primary to-secondary rounded-2xl blur-2xl opacity-30 animate-pulse" />
              <div className="relative bg-card border border-border rounded-xl lg:rounded-2xl p-3 lg:p-4 xl:p-6 2xl:p-8 shadow-elevation-lg backdrop-blur-sm">
                <div className="aspect-square relative rounded-lg lg:rounded-xl overflow-hidden mb-2 lg:mb-3 xl:mb-4 2xl:mb-6 group">
                  <img
                    src="/Capa.png"
                ...
                <div className="space-y-1.5 lg:space-y-2 xl:space-y-2.5 2xl:space-y-3">
                  <div className="flex items-center justify-between p-2 lg:p-2.5 xl:p-3 2xl:p-4 bg-background rounded-lg border border-border">
                    <div className="flex items-center gap-2 lg:gap-2.5 xl:gap-3">
                      <div className="p-1.5 lg:p-1.5 xl:p-2 bg-primary/10 rounded-lg">
                        <svg className="w-3.5 h-3.5 lg:w-4 lg:h-4 xl:w-5 xl:h-5 text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
                        </svg>
                      </div>
                      <div>
                        <p className="text-[10px] lg:text-xs xl:text-sm text-muted-foreground">
                          Projetos de Dados
                        </p>
                        <p className="text-base lg:text-lg xl:text-xl 2xl:text-2xl font-headline font-bold text-foreground">
                          50+
                        </p>
                      </div>
                    </div>
                  ...
                  <div className="flex items-center justify-between p-2 lg:p-2.5 xl:p-3 2xl:p-4 bg-background rounded-lg border border-border">
                    <div className="flex items-center gap-2 lg:gap-2.5 xl:gap-3">
                      <div className="p-1.5 lg:p-1.5 xl:p-2 bg-secondary/10 rounded-lg">
                        <svg className="w-3.5 h-3.5 lg:w-4 lg:h-4 xl:w-5 xl:h-5 text-secondary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <div className="flex items-center justify-between p-2 lg:p-2.5 xl:p-3 2xl:p-4 bg-background rounded-lg border border-border">
                    <div className="flex items-center gap-2 lg:gap-2.5 xl:gap-3">
                      <div className="p-1.5 lg:p-1.5 xl:p-2 bg-accent/10 rounded-lg">
                        <svg className="w-3.5 h-3.5 lg:w-4 lg:h-4 xl:w-5 xl:h-5 text-accent" fill="none" stroke="currentColor" viewBox="0 0 24 24">
